...
public class WaterRenderer {
	...
	private static final String DUDV_MAP = "DUDVMap1";
	private static final String NORMAL_MAP = "NormalMap2";
    ...
    public WaterRenderer(Loader loader, WaterShader shader, Matrix4f projectionMatrix, WaterFrameBuffers fbos) {
        this.shader = shader;
        this.fbos = fbos;
        dudvTexture = loader.loadWaterMapTexture(DUDV_MAP);
        normalMap = loader.loadWaterMapTexture(NORMAL_MAP);
        shader.start();
